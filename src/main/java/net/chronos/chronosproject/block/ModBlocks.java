...
public class ModBlocks {
    public static final Block CHRONOS_CONCRETE = registerBlock("chronos_concrete",
            new Block(AbstractBlock.Settings.create().strength(1.8f).hardness(1.8F)), ModItemGroup.CHRONOSPROJECT);
    ...
    public static final Block CHRONOS_CONCRETE_POWDER = registerBlock("chronos_concrete_powder",
            new ModConcretePowderBlock(ModBlocks.CHRONOS_CONCRETE, AbstractBlock.Settings.create().sounds(BlockSoundGroup.SAND).strength(0.5f).hardness(0.5F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block PIPSKIY_CONCRETE_POWDER = registerBlock("pipskiy_concrete_powder",
            new ModConcretePowderBlock(ModBlocks.PIPSKIY_CONCRETE, AbstractBlock.Settings.create().sounds(BlockSoundGroup.SAND).strength(0.5f).hardness(0.5F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block WHITE_CONCRETE_SLAB = registerBlock("white_concrete_slab",
            new SlabBlock(AbstractBlock.Settings.create().strength(1.8f).hardness(1.8F)), ModItemGroup.CHRONOSPROJECT);
    ...
    public static final Block WHITE_TERRACOTTA_SLAB = registerBlock("white_terracotta_slab",
            new SlabBlock(AbstractBlock.Settings.create().strength(4.2f).hardness(1.25f)), ModItemGroup.CHRONOSPROJECT);
    ...
    public static final Block WHITE_CONCRETE_STAIRS = registerBlock("white_concrete_stairs",
            new ModStairsBlock(Blocks.WHITE_CONCRETE.getDefaultState(),AbstractBlock.Settings.create().strength(1.8f).hardness(1.8F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block ORANGE_CONCRETE_STAIRS = registerBlock("orange_concrete_stairs",
            new ModStairsBlock(Blocks.ORANGE_CONCRETE.getDefaultState(), AbstractBlock.Settings.create().strength(1.8f).hardness(1.8F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block MAGENTA_CONCRETE_STAIRS = registerBlock("magenta_concrete_stairs",
            new ModStairsBlock(Blocks.MAGENTA_CONCRETE.getDefaultState(), AbstractBlock.Settings.create().strength(1.8f).hardness(1.8F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block LIGHT_BLUE_CONCRETE_STAIRS = registerBlock("light_blue_concrete_stairs",
            new ModStairsBlock(Blocks.LIGHT_BLUE_CONCRETE.getDefaultState(), AbstractBlock.Settings.create().strength(1.8f).hardness(1.8F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block YELLOW_CONCRETE_STAIRS = registerBlock("yellow_concrete_stairs",
            new ModStairsBlock(Blocks.YELLOW_CONCRETE.getDefaultState(), AbstractBlock.Settings.create().strength(1.8f).hardness(1.8F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block LIME_CONCRETE_STAIRS = registerBlock("lime_concrete_stairs",
            new ModStairsBlock(Blocks.LIME_CONCRETE.getDefaultState(), AbstractBlock.Settings.create().strength(1.8f).hardness(1.8F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block PINK_CONCRETE_STAIRS = registerBlock("pink_concrete_stairs",
            new ModStairsBlock(Blocks.PINK_CONCRETE.getDefaultState(), AbstractBlock.Settings.create().strength(1.8f).hardness(1.8F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block GRAY_CONCRETE_STAIRS = registerBlock("gray_concrete_stairs",
            new ModStairsBlock(Blocks.GRAY_CONCRETE.getDefaultState(), AbstractBlock.Settings.create().strength(1.8f).hardness(1.8F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block LIGHT_GRAY_CONCRETE_STAIRS = registerBlock("light_gray_concrete_stairs",
            new ModStairsBlock(Blocks.LIGHT_GRAY_CONCRETE.getDefaultState(), AbstractBlock.Settings.create().strength(1.8f).hardness(1.8F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block CYAN_CONCRETE_STAIRS = registerBlock("cyan_concrete_stairs",
            new ModStairsBlock(Blocks.CYAN_CONCRETE.getDefaultState(), AbstractBlock.Settings.create().strength(1.8f).hardness(1.8F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block PURPLE_CONCRETE_STAIRS = registerBlock("purple_concrete_stairs",
            new ModStairsBlock(Blocks.PURPLE_CONCRETE.getDefaultState(), AbstractBlock.Settings.create().strength(1.8f).hardness(1.8F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block BLUE_CONCRETE_STAIRS = registerBlock("blue_concrete_stairs",
            new ModStairsBlock(Blocks.BLUE_CONCRETE.getDefaultState(), AbstractBlock.Settings.create().strength(1.8f).hardness(1.8F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block BROWN_CONCRETE_STAIRS = registerBlock("brown_concrete_stairs",
            new ModStairsBlock(Blocks.BROWN_CONCRETE.getDefaultState(), AbstractBlock.Settings.create().strength(1.8f).hardness(1.8F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block GREEN_CONCRETE_STAIRS = registerBlock("green_concrete_stairs",
            new ModStairsBlock(Blocks.GREEN_CONCRETE.getDefaultState(), AbstractBlock.Settings.create().strength(1.8f).hardness(1.8F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block RED_CONCRETE_STAIRS = registerBlock("red_concrete_stairs",
            new ModStairsBlock(Blocks.RED_CONCRETE.getDefaultState(), AbstractBlock.Settings.create().strength(1.8f).hardness(1.8F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block BLACK_CONCRETE_STAIRS = registerBlock("black_concrete_stairs",
            new ModStairsBlock(Blocks.BLACK_CONCRETE.getDefaultState(), AbstractBlock.Settings.create().strength(1.8f).hardness(1.8F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block CHRONOS_CONCRETE_STAIRS = registerBlock("chronos_concrete_stairs",
            new ModStairsBlock(ModBlocks.CHRONOS_CONCRETE.getDefaultState(), AbstractBlock.Settings.create().strength(1.8f).hardness(1.8F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block PIPSKIY_CONCRETE_STAIRS = registerBlock("pipskiy_concrete_stairs",
            new ModStairsBlock(ModBlocks.PIPSKIY_CONCRETE.getDefaultState(), AbstractBlock.Settings.create().strength(1.8f).hardness(1.8F)), ModItemGroup.CHRONOSPROJECT);


    public static final Block WHITE_TERRACOTTA_STAIRS = registerBlock("white_terracotta_stairs",
            new ModStairsBlock(Blocks.WHITE_TERRACOTTA.getDefaultState(),AbstractBlock.Settings.create().strength(4.2f).hardness(1.25F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block ORANGE_TERRACOTTA_STAIRS = registerBlock("orange_terracotta_stairs",
            new ModStairsBlock(Blocks.ORANGE_TERRACOTTA.getDefaultState(), AbstractBlock.Settings.create().strength(4.2f).hardness(1.25F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block MAGENTA_TERRACOTTA_STAIRS = registerBlock("magenta_terracotta_stairs",
            new ModStairsBlock(Blocks.MAGENTA_TERRACOTTA.getDefaultState(), AbstractBlock.Settings.create().strength(4.2f).hardness(1.25F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block LIGHT_BLUE_TERRACOTTA_STAIRS = registerBlock("light_blue_terracotta_stairs",
            new ModStairsBlock(Blocks.LIGHT_BLUE_TERRACOTTA.getDefaultState(), AbstractBlock.Settings.create().strength(4.2f).hardness(1.25F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block YELLOW_TERRACOTTA_STAIRS = registerBlock("yellow_terracotta_stairs",
            new ModStairsBlock(Blocks.YELLOW_TERRACOTTA.getDefaultState(), AbstractBlock.Settings.create().strength(4.2f).hardness(1.25F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block LIME_TERRACOTTA_STAIRS = registerBlock("lime_terracotta_stairs",
            new ModStairsBlock(Blocks.LIME_TERRACOTTA.getDefaultState(), AbstractBlock.Settings.create().strength(4.2f).hardness(1.25F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block PINK_TERRACOTTA_STAIRS = registerBlock("pink_terracotta_stairs",
            new ModStairsBlock(Blocks.PINK_TERRACOTTA.getDefaultState(), AbstractBlock.Settings.create().strength(4.2f).hardness(1.25F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block GRAY_TERRACOTTA_STAIRS = registerBlock("gray_terracotta_stairs",
            new ModStairsBlock(Blocks.GRAY_TERRACOTTA.getDefaultState(), AbstractBlock.Settings.create().strength(4.2f).hardness(1.25F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block LIGHT_GRAY_TERRACOTTA_STAIRS = registerBlock("light_gray_terracotta_stairs",
            new ModStairsBlock(Blocks.LIGHT_GRAY_TERRACOTTA.getDefaultState(), AbstractBlock.Settings.create().strength(4.2f).hardness(1.25F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block CYAN_TERRACOTTA_STAIRS = registerBlock("cyan_terracotta_stairs",
            new ModStairsBlock(Blocks.CYAN_TERRACOTTA.getDefaultState(), AbstractBlock.Settings.create().strength(4.2f).hardness(1.25F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block PURPLE_TERRACOTTA_STAIRS = registerBlock("purple_terracotta_stairs",
            new ModStairsBlock(Blocks.PURPLE_TERRACOTTA.getDefaultState(), AbstractBlock.Settings.create().strength(4.2f).hardness(1.25F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block BLUE_TERRACOTTA_STAIRS = registerBlock("blue_terracotta_stairs",
            new ModStairsBlock(Blocks.BLUE_TERRACOTTA.getDefaultState(), AbstractBlock.Settings.create().strength(4.2f).hardness(1.25F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block BROWN_TERRACOTTA_STAIRS = registerBlock("brown_terracotta_stairs",
            new ModStairsBlock(Blocks.BROWN_TERRACOTTA.getDefaultState(), AbstractBlock.Settings.create().strength(4.2f).hardness(1.25F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block GREEN_TERRACOTTA_STAIRS = registerBlock("green_terracotta_stairs",
            new ModStairsBlock(Blocks.GREEN_TERRACOTTA.getDefaultState(), AbstractBlock.Settings.create().strength(4.2f).hardness(1.25F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block RED_TERRACOTTA_STAIRS = registerBlock("red_terracotta_stairs",
            new ModStairsBlock(Blocks.RED_TERRACOTTA.getDefaultState(), AbstractBlock.Settings.create().strength(4.2f).hardness(1.25F)), ModItemGroup.CHRONOSPROJECT);
    public static final Block BLACK_TERRACOTTA_STAIRS = registerBlock("black_terracotta_stairs",
            new ModStairsBlock(Blocks.BLACK_TERRACOTTA.getDefaultState(), AbstractBlock.Settings.create().strength(4.2f).hardness(1.25F)), ModItemGroup.CHRONOSPROJECT);

    public static final Block WHITE_CONCRETE_PRESSURE_PLATE = registerBlock("white_concrete_pressure_plate",
            new PressurePlateBlock(BlockSetType.STONE, AbstractBlock.Settings.create().strength(1.8f).hardness(1.8F).pistonBehavior(PistonBehavior.DESTROY)), ModItemGroup.CHRONOSPROJECT);
    ...
    public static final Block WHITE_TERRACOTTA_PRESSURE_PLATE = registerBlock("white_terracotta_pressure_plate",
            new PressurePlateBlock(BlockSetType.STONE, AbstractBlock.Settings.create().strength(4.2f).hardness(1.25f).pistonBehavior(PistonBehavior.DESTROY)), ModItemGroup.CHRONOSPROJECT);
    ...
    public static final Block WHITE_CONCRETE_WALL = registerBlock("white_concrete_wall",
            new WallBlock(AbstractBlock.Settings.create().strength(1.8f).hardness(1.8F)), ModItemGroup.CHRONOSPROJECT);
    ...
    public static final Block WHITE_TERRACOTTA_WALL = registerBlock("white_terracotta_wall",
            new WallBlock(AbstractBlock.Settings.create().strength(4.2f).hardness(1.25f)), ModItemGroup.CHRONOSPROJECT);
    ...
    public static final Block SLICE_OF_CAKE = registerBlock("slice_of_cake",
            new SliceOfCake(AbstractBlock.Settings.create().strength(2.0f)), ModItemGroup.CHRONOSPROJECT, "tooltip.chronosproject.block.slice_of_cake", 1);
    ...
    private static Block registerBlock(String name, Block block,  RegistryKey<ItemGroup> tab, String tooltipKey, Integer stackSize){
        ...
        return Registry.register(Registries.BLOCK, Identifier.of(ChronosProject.MOD_ID, name), block);
    }

    private static void registerBlockItem(String name, Block block, RegistryKey<ItemGroup> tab, String tooltipKey, Integer stackSize){
        Item item = Registry.register(Registries.ITEM, Identifier.of(ChronosProject.MOD_ID, name),
